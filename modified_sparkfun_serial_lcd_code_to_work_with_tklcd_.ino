 ...
 * 
 * changed Serial to Serial1 for the Leonardo board,
 * Changed LCD pins to match the TKLCD
 * 
 * * LCD RS pin to digital pin A4
  * LCD R/W pin to digital pin A5
  ...
  * LCD D7 pin to digital pin 8
  * 
  * Backlight Pin 10, Contrast Pin 9
  * 
  *This came about because the TKLCD serial firmware was not working
  *for me. It doesn't need or use the TKLCD library.
  *
 */
...
void setup(){
  ...
  analogWrite(BLPin, DEFAULT_BRIGHTNESS);
  analogWrite(CONTRASTPIN, 255-DEFAULT_CONTRAST);
